...
export class MakeMonsterSpawnHideRegionAction extends MakeAction {
    ...
    cancel = (): boolean => {
        ...
        this.owner && Text.mkP(this.owner.getPlayer(), 'monster spawn dead zone creation cancelled')
        return true
    }
    ...
    redo = (): boolean => {
        ...
        this.owner && Text.mkP(this.owner.getPlayer(), 'monster spawn dead zone redone')
        return true
    }
}
