...
export class MonsterSpawn {
    ...
    startMobMovement = (mobUnit: unit, ms: MonsterSpawn, spawnIndex: number, spawnAmount: number) => {
        ...
        if (this.rotation === 90 || this.rotation === 270) {
            ...
            x2 =
                this.monsterDirectionMode === 'straight'
                    ? x1
                    : this.calcValOffset(this.minX, this.maxX, spawnIndex, spawnAmount)
            y1 = this.maxY
            ...
            y2 =
                this.monsterDirectionMode === 'straight'
                    ? y1
                    : this.calcValOffset(this.minY, this.maxY, spawnIndex, spawnAmount)
