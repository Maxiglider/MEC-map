//TESH.scrollpos=38
//TESH.alwaysfold=0
library MakeTerrainHorizontalSymmetryAction needs MakeAction, ModifyTerrainFunctions
...
struct MakeTerrainHorizontalSymmetryAction extends MakeAction   
    ...
    static method create takes real x1, real y1, real x2, real y2 returns MakeTerrainHorizontalSymmetryAction
        local MakeTerrainHorizontalSymmetryAction a
        ...
        set a = MakeTerrainHorizontalSymmetryAction.allocate()
        set a.minX = minX
        set a.minY = minY
        set a.maxX = maxX
        set a.maxY = maxY
