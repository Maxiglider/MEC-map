//TESH.scrollpos=0
//TESH.alwaysfold=0
library MakeMeteor needs Make



struct MakeMeteor extends Make    	
	static method create takes unit maker returns MakeMeteor
        local MakeMeteor m
		if (maker == null) then
			return 0
		endif
        set m = MakeMeteor.allocate()
        set m.maker = maker
        set m.kind = "meteorCreate"
