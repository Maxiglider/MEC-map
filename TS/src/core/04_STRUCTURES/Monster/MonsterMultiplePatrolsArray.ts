export class MonsterMultiplePatrolsArray {
    //50 niveaux * 500 monstres

    private monsters: MonsterMultiplePatrols[]
    ...
    get = (arrayId: number): MonsterMultiplePatrols => {
    ...
    new = (mt: MonsterType, mode: string, createUnit: boolean): MonsterMultiplePatrols => {
        let n: number
    ...
    getMonsterNear = (x: number, y: number): MonsterMultiplePatrols => {
        let xMob: number
        let yMob: number
        let i = 0
        while (true) {
