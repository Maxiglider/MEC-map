export class MonsterSimplePatrolArray {
    //50 niveaux * 500 monstres

    private monsters: MonsterSimplePatrol[] = []
    ...
    get = (arrayId: number): MonsterSimplePatrol => {
    ...
    getMonsterNear = (x: number, y: number): MonsterSimplePatrol => {
        let xMob: number
        let yMob: number
        let i = 0
        while (true) {
