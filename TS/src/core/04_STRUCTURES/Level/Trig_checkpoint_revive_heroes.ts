...
const initTrigCheckpointReviveHeroes = () => {
    ...
    const gg_trg____Trig_checkpoint_revive_heroes = createEvent({
        events: [],
        actions: [
            () => {
    ...
    return {
        levelForReviving,
        revivingFinisher,
        gg_trg____Trig_checkpoint_revive_heroes,
        initTrigCheckpointReviveHeroes,
    }
}

export const TrigCheckpointReviveHeroes = initTrigCheckpointReviveHeroes()
