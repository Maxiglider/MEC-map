...
//struct ClearMob //50 niveaux * 160

    Level level
    integer arrayId
// TODO; Used to be private
     MonsterOrCaster triggerMob
// TODO; Used to be private
     MonsterOrCasterStack blockMobs
// TODO; Used to be private
     real disableDuration //0 = permanent
// TODO; Used to be private
     timer timerActivated
// TODO; Used to be private
     timer timerFrontMontant //le trigger mob reste en vert pêtant le temps du "front montant"
    boolean enabled
// TODO; Used to be private
     effect triggerMobPermanentEffect
...
const setDisableDuration = (disableDuration: number): boolean => {
...
const getBlockMobs = (): MonsterOrCasterStack => {
...
const initialize = (): void => {
 ...
 this.triggerMob.setVertexColor(30, 60, 100)
	if ((this.triggerMobPermanentEffect === null)) {
		this.triggerMobPermanentEffect = AddSpecialEffectTarget(TRIGGER_MOB_PERMANENT_EFFECT, this.triggerMob.getUnit(), "origin")
	}
	this.enabled = true;
};
...
const addBlockMob = (blockMobId: number): boolean => {
...
const removeLastBlockMob = (): boolean => {
...
const isBeingActivated = (): boolean => {
