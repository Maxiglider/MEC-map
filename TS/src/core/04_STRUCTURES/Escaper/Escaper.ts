...
class Escaper {
    ...
    makeMmpOrMtNext() {
        ...
        if (
            this.make == 0 ||
            !(this.make.getType() == MakeMonsterMultiplePatrols.typeid || this.make.getType() == MakeMonsterTeleport.typeid)
        ) {
            return false
        }
    ...
    makeMonsterTeleportWait() {
        this.onInitMake()
        if (this.make == 0 || this.make.getType() != MakeMonsterTeleport.typeid) {
            return false
        }
