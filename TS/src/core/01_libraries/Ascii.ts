export const Ascii = () => {
    ...
    const CaractereVersAscii = (caractere: string): number => {
    ...
    const AsciiVersCaractere = (source: number): string => {
    ...
    const String2Ascii = (source: string): number => {
    ...
    const Ascii2String = (source: number): string => {
