...
- **Encore ouvert** :
    ...
    - **La progression du multiboard** est calculée depuis la position locale des héros async ; `-lockcam progression` choisit sa cible avec, et `resetCamera` peut créer ou détruire un timer.
