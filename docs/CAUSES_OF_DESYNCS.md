...
- **Still open**:
    ...
    - **Multiboard progression** is computed from the local position of async heroes; `-lockcam progression` picks its target from it, and `resetCamera` may create or destroy a timer.
